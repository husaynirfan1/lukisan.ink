...
import { Crown, Loader2, Check, Sparkles, AlertTriangle } from 'lucide-react';
  ...
  return (
    <>
          ...
          <div className="mb-6 p-4 bg-orange-100 border border-orange-200 rounded-lg">
            <div className="flex items-center space-x-2">
              ...
              <p className="text-orange-800 font-medium">
                Email verification required for payments
              </p>
            </div>
            <p className="text-orange-700 text-sm mt-1">
              Please verify your email address before upgrading to Creator.
            </p>
          </div>
        )}
      ...
      <EmailVerificationModal
        ...
        message="Please verify your email address before making a purchase. This helps us protect your account and ensure you receive important updates about your subscription."
      />
    </>
  );
};