        ...
        try {
            const { data, error: dbError } = await supabase
              ...
              .insert({
                ...
                storage_path: 'progress: 0%' // Track progress
              })
              .select('id')
              .single();
            ...
            if (dbError) {
              ...
              // Start monitoring with the VideoStatusManager
              videoStatusManager.startMonitoring(data.id, validTaskId, user.id);
            }
        } catch (dbError) {
